...
public class TtsMain {
    ...
    private final String appKey = "MRNKgTjzPreGsrChZuaC4ZFF";

    // 填写网页上申请的APP SECRET 如 $secretKey="94dc99566550d87f8fa8ece112xxxxx"
    private final String secretKey = "veKlZENKZXKKDXyv4q2xcvRXXftCm9j3";

    // text 的内容为"欢迎使用百度语音合成"的urlencode,utf-8 编码
    // 可以百度搜索"urlencode"
    private final String text = "好嗨啊，感觉人生达到了巅峰！";
